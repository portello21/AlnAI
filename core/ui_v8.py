...
html,body,.stApp,[data-testid="stAppViewContainer"]{background:radial-gradient(900px 420px at 65% -180px,rgba(124,87,255,.18),transparent 72%),var(--rog-bg)!important;color:var(--rog-text)!important}body{font-family:Inter,ui-sans-serif,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif!important}#MainMenu,footer,.stDeployButton,[data-testid="stToolbar"]{display:none!important}[data-testid="stHeader"]{height:54px!important;background:transparent!important;pointer-events:none!important}[data-testid="stSidebarCollapsedControl"],[data-testid="stSidebarCollapseButton"]{display:flex!important;visibility:visible!important;opacity:1!important;position:fixed!important;top:10px!important;left:10px!important;z-index:10000!important;pointer-events:auto!important;background:#11141d!important;border:1px solid rgba(178,156,255,.35)!important;border-radius:11px!important;color:#fff!important;box-shadow:0 8px 28px rgba(0,0,0,.4)!important}[data-testid="stAppViewBlockContainer"]{padding-top:0!important}.block-container{max-width:1120px!important;padding:24px clamp(20px,4vw,54px) 140px!important}a{color:var(--rog-accent2)!important}*:focus-visible{outline:2px solid var(--rog-accent2)!important;outline-offset:2px!important}
